...
public class AutoLinkTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private int mentionModeColor = getResources().getColor(R.color.default_high_light_color);
    private int hashtagModeColor = getResources().getColor(R.color.hashtag_color);
